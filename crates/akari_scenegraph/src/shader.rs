...
pub enum ShaderNode {
    ...
    #[serde(rename = "sty_toon")]
    Toon {
        surface: NodeRef<ShaderNode>,
        color_band_width: NodeRef<ShaderNode>,
    },
    #[serde(rename = "sty_8bit")]
    EightBit {
        surface: NodeRef<ShaderNode>,
        indirect_scale: NodeRef<ShaderNode>,
    },
    #[serde(rename = "sty_color_palette")]
    ColorPalette {
        surface: NodeRef<ShaderNode>,
        palette: Vec<String>,
        indirect_scale: NodeRef<ShaderNode>,
        gamma: NodeRef<ShaderNode>,
    },
    #[serde(rename = "sty_hue_shift")]
    HueShift {
        surface: NodeRef<ShaderNode>,
        shift: NodeRef<ShaderNode>,
        indirect_scale: NodeRef<ShaderNode>,
    },
    #[serde(rename = "sty_saturation_adjust")]
    SaturationAdjust {
        surface: NodeRef<ShaderNode>,
        power: NodeRef<ShaderNode>,
        indirect_scale: NodeRef<ShaderNode>,
        max_depth: u32,
    },
    #[serde(rename = "sty_saturation_adjust_rex")]
    SaturationAdjustRex {
        surface: NodeRef<ShaderNode>,
        blend: NodeRef<ShaderNode>,
    },
    #[serde(rename = "sty_half_tone")]
    HalfTone {
        surface: NodeRef<ShaderNode>,
        trs: TRS,
        radius_scale: NodeRef<ShaderNode>,
        radius: NodeRef<ShaderNode>,
        indirect_scale: NodeRef<ShaderNode>,
        grid_distance: NodeRef<ShaderNode>,
        max_depth: u32,
        blend: NodeRef<ShaderNode>,
        light_tone: NodeRef<ShaderNode>,
        dark_tone: NodeRef<ShaderNode>,
    },
    #[serde(rename = "sty_enable_if")]
    EnableStylizationIf {
        surface: NodeRef<ShaderNode>,
        idx: u32,
        #[serde(default)]
        #[serde(rename = "else")]
        else_: Option<NodeRef<ShaderNode>>,
    },
    #[serde(rename = "sty_set_idx")]
    SetStylizationIndex {
        surface: NodeRef<ShaderNode>,
        idx: u32,
    },
    ...
    fn visit_mut(&mut self, graph: &mut ShaderGraph, node: &NodeRef<ShaderNode>) {
        ...
        match node {
            ...
            ShaderNode::Toon {
                ...
                graph.visit_mut(self, &surface);
                graph.visit_mut(self, &color_band_width);
            }
            ShaderNode::MixBsdf {
                first,
                second,
