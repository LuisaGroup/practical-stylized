...
pub struct SvmToon {
    ...
    pub color_band_width: SvmNodeRef,
}
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
#[repr(C)]
pub struct Svm8Bit {
    pub surface: SvmNodeRef,
    pub indirect_scale: SvmNodeRef,
}
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
#[repr(C)]
pub struct SvmHalfTone {
    pub surface: SvmNodeRef,
    pub indirect_scale: SvmNodeRef,
    pub affine: SvmNodeRef,
    pub radius: SvmNodeRef,
    pub radius_scale: SvmNodeRef,
    pub max_depth: SvmNodeRef,
    pub grid_distance: SvmNodeRef,
    pub dark_tone: SvmNodeRef,
    pub light_tone: SvmNodeRef,
    pub blend: SvmNodeRef,
}
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
#[repr(C)]
pub struct SvmSetStyleIdx {
    pub surface: SvmNodeRef,
    pub idx: SvmConst<u32>,
}
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
#[repr(C)]
pub struct SvmEnableIf {
    pub surface: SvmNodeRef,
    pub idx: SvmConst<u32>,
    pub else_: SvmNodeRef,
}
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
#[repr(C)]
pub struct SvmSaturationAdjust {
    pub surface: SvmNodeRef,
    pub power: SvmNodeRef,
    pub indirect_scale: SvmNodeRef,
    pub max_depth: SvmNodeRef,
}
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
#[repr(C)]
pub struct SvmSaturationAdjustRex {
    pub surface: SvmNodeRef,
    pub blend: SvmNodeRef,
}
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
#[repr(C)]
pub struct SvmColorPalette {
    pub surface: SvmNodeRef,
    pub palette: SvmConst<Float3>,
    pub length: SvmConst<u32>,
    pub indirect_scale: SvmNodeRef,
    pub gamma: SvmNodeRef,
}
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
#[repr(C)]
...
pub enum SvmNode {
    ...
    Uint(SvmConst<u32>),
    AffineTransform(SvmConst<AffineTransform>),
    RgbTex(SvmRgbTex),
    ...
    Toon(SvmToon),
    EightBit(Svm8Bit),
    SaturationAdjust(SvmSaturationAdjust),
    SaturationAdjustRex(SvmSaturationAdjustRex),
    HalfTone(SvmHalfTone),
    ColorPalette(SvmColorPalette),
    MaterialOutput(SvmMaterialOutput),
    EnableStylizationIf(SvmEnableIf),
    SetStyleIdx(SvmSetStyleIdx),
    Null(SvmNullSurface),
}
